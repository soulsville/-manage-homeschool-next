...
export default class TeacherClassShowStudentsComponent extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        console.log("in TeacherClassShowStudentsComponent class....");
    }
    ...
    showStudentsComponent = () => {
        ...
        return (
            ...
            renderItem={item => (
                <List.Item
                    actions={[
                        <a key={item.uid} onClick={() => context.teacherClassComponentHandleTeacherStudentClick(item)}>
                        {context.teacherClassComponent.individualStudentEditLoading ?
